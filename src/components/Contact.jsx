...
const Contact = () => {
  ...
  const handleSubmit=(e)=>{
    ...
    emailjs.send('service_22tk3xi',
                 'template_49bwzjq',
                    {
                        from_name:form.name,
                        to_name:'Akshay Balapure',
                        from_email:form.email,   
                        to_email:'balapure1996@gmail.com',
        ...
        className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
            ...
            >
              ...
              <label className="flex flex-col">
                  ...
                  <textarea type="text" name="message" value={form.message} onChange={handleChange} placeholder="what do you want to say"
                     className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outlined-none border-none font-medium"
                  />
              </label>
                <button className="bg-tertiary py-3 px-8 outline-none w-fit text-white 
                  font-bold shadow-md shadow-primary roundex-xl">
